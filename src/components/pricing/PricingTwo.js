...
function PricingTwo() {
  return (
    <div>
        ...
        <div className="rts-pricing-area rts-section-gapTop gradient-bg-pricing">
            ...
            <div className="row g-0 mt--80">
                ...
                <div className="single-pricing-area-start-2 border-left">
                    ...
                    <div className="single-check">
                        <img src="assets/images/pricing/icon/04.svg" alt="pricing" />
                ...
                <div className="single-pricing-area-start-2 active">
                    ...
                    <div className="body-areas">
                    <div className="single-check">
                        <img src="assets/images/pricing/icon/05.svg" alt="pricing" />
                        <p>Access to all basic features</p>
                    </div>
                    <div className="single-check">
                        <img src="assets/images/pricing/icon/05.svg" alt="pricing" />
            ...
            <div className="row">
                <div className="col-lg-12 text-center mt_sm--30 mt_md--30">
